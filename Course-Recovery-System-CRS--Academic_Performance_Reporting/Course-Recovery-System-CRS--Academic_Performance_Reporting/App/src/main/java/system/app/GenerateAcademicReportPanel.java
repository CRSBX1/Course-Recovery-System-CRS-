...
import java.awt.*;
import java.io.File;
import system.app.SafeFileLoader;
import system.app.email.StudentEmailMap;
import system.app.email.SendReportPopup;
...
public class GenerateAcademicReportPanel extends JPanel {
    ...
    private JPanel createStudentDetailsPanel() {
        ...
        detailsCard.setBackground(new Color(173, 216, 230));
        ...
        detailsCard.add(Box.createVerticalStrut(40));
    ...
    private void sendEmail() {
        ...
        SendReportPopup.open(selectedStudent.getStudentID());
    }
